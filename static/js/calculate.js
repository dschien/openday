...
function calc() {
	...
	document.getElementById('text_infra').innerHTML = "<h2>Internet<br/></h2></h2><p>" + Math.round(e_network / 36) / 100 + " Wh</p><p> " + Math.round(p_network) + " &#37;</p>"
	...
	document.getElementById('text_server').innerHTML = "<h2>servers<br/><p>" + Math.round(e_serv / 36) / 100 + " Wh</p><p> " + Math.round(p_serv) + " &#37;</p>"
