...
function calc() {
	...
	switch(connectionType) {
		case '3G mobile':
			...
			document.getElementById('circle_device').innerHTML = '<div style="width:' + circle_user + 'px; height:' + circle_user + 'px;margin-left:' + margin + 'px;margin-top:' + margintop + 'px; background:#C7E2EC; -moz-border-radius: 300px; -webkit-border-radius:300px;"></div>'
			...
			document.getElementById('circle_infra').innerHTML = '<div style="width:' + circle_internet + 'px; height:' + circle_internet + 'px; margin-left:' + margin + 'px;margin-top:' + margintop + 'px; background:#51A1B7; -moz-border-radius: 300x; -webkit-border-radius:300px;"></div>'
		...
		document.getElementById('circle_access').innerHTML = '<div style="width:' + circle_acc_net + 'px; height:' + circle_acc_net + 'px;margin-left:' + margin + 'px;margin-top:' + margintop + 'px; background:#A3C3D8; -moz-border-radius: 300px; -webkit-border-radius:300px;"></div>'
		...
		margin = (100 - circle_internet) / 2
		margintop = (100 - circle_internet) / 3
		document.getElementById('circle_infra').innerHTML = '<div style="width:' + circle_internet + 'px; height:' + circle_internet + 'px; margin-left:' + margin + 'px;margin-top:' + margintop + 'px; background:#51A1B7; -moz-border-radius: 300px; -webkit-border-radius:300px;"></div>'
